...
<template>
  <section class="max-w-5xl">
    ...
    <div class="bg-surface-container-low p-8 rounded-lg border border-white/5">
      <form @submit.prevent="handleSubmit" class="flex flex-col gap-6">
        ...
        <div class="pt-4 border-t border-white/5 mt-2 flex justify-end">
          <button type="submit" :disabled="isLoading || !allRulesPassed" class="bg-primary-container text-on-primary font-bold text-xs uppercase tracking-widest px-8 py-3 transition-transform active:scale-95 hover:bg-primary-fixed-dim rounded-sm disabled:opacity-60 disabled:cursor-not-allowed">
    ...
    <aside class="bg-surface-container-low p-6 rounded-lg border border-white/5 lg:sticky lg:top-24">
      <h3 class="text-[10px] uppercase font-bold tracking-widest text-on-surface-variant mb-4 flex items-center gap-2">
