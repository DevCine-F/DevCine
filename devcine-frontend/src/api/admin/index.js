...
export const incidentApi = {
  ...
  futureConflicts: (seatId) => api.get(`/staff/incidents/seats/${seatId}/future-conflicts`),
  ...
  exportHistory: (params) => api.get('/staff/incidents/export', { params, responseType: 'blob' }),
